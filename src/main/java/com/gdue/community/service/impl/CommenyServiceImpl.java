...
import com.gdue.community.dao.CommentMapper;
...
//评论业务
@Service
public class CommenyServiceImpl implements CommentService, CommunityConstant {
    ...
    @Override
    public List<Comment> findCommenyByEntity(int entityType, int entityId, int offset, int limit) {
